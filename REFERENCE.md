...
* [`simp_ad`](#simp_ad): Placeholder class for now
* [`simp_ad::client::install`](#simp_adclientinstall): Run ipa-client-install on puppet clients

_Private Classes_

* `simp_ad::client::packages`: Class to contain packages required for simp::simp_ad::install
...
The following parameters are available in the `simp_ad::client::install` class.
